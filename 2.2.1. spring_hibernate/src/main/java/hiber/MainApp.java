...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      User user1 = new User("Methun", "Chaktaborti", "Methun@ind.com");
      User user2 = new User("Ashvari", "Rai", "Ashvari@ind.com");
      User user3 = new User("Shuhruh", "Khan", "Shuhruh.com");
      User user4 = new User("Radj", "Kapur", "Radj@ind.com");
